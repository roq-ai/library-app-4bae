  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Experience seamless library management with Library App, a robust solution built in C# and Azure Cloud, leveraging SQL for unparalleled efficiency and performance."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1481627834876-b7833e8f5570?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxsaWJyYXJ5fGVufDB8fHx8MTY5NzI0ODc2NHww&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
          ...
          <Box position="absolute" top="0" backgroundColor="rgba(0,0,0,0.6)" width="100%" py="2">
            <Text align="center" fontSize="sm" color="white">
              Photo by{' '}
              <Link
                href="https://unsplash.com/@itfeelslikefilm?utm_source=roq-generator&utm_medium=referral"
                isExternal
                color="teal.200"
              >{`🇸🇮 Janko Ferlič`}</Link>{' '}
              on{' '}
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Experience seamless library management with Library App, a robust solution built in C# and Azure Cloud, leveraging SQL for unparalleled efficiency and performance.`}
            </Text>
            <Box
