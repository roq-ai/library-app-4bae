...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'New Book Added.create': {
    roles: ['system-administrator', 'librarian', 'it-support', 'library-member'],
    key: 'book_added',
    tenantPath: [],
    userPath: [],
  },
  'Book Checked Out.update': {
    roles: ['system-administrator', 'library-manager', 'it-support', 'library-member'],
    key: 'book_checked_out',
    tenantPath: [],
    userPath: [],
  },
  'Book Returned.update': {
    roles: ['system-administrator', 'library-manager', 'librarian', 'it-support'],
    key: 'book_returned',
    tenantPath: [],
    userPath: [],
  },
...
const tenantRoles: string[] = ['system-administrator', 'library-manager', 'librarian', 'it-support', 'library-member'];
